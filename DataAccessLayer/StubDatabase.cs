...
namespace DataAccessLayer
{
    class StubDatabase : IBridge
    {
        ...
        public StubDatabase()
        {
            ...
            users.Add(new Utilisateur(1, "begarco", "9e0513b4d4dd9b954a043d3ccd0c9e6281f3fede", "Garçon", "Benoît"));
            #endregion
            ...
            jedis.Add(new Jedi(1, carAdd, false, "Obi Wan Kenobi", "default.png"));
            carAdd = new List<Caracteristique>();
            carAdd.Add(caracs[9]); carAdd.Add(caracs[11]); carAdd.Add(caracs[22]); carAdd.Add(caracs[8]);
            jedis.Add(new Jedi(2, carAdd, false, "Yoda", "default.png"));
            carAdd = new List<Caracteristique>();
            carAdd.Add(caracs[9]); carAdd.Add(caracs[11]); carAdd.Add(caracs[22]);carAdd.Add(caracs[23]);
            jedis.Add(new Jedi(3, carAdd, false, "Mace Windu", "default.png"));
            carAdd = new List<Caracteristique>();
            carAdd.Add(caracs[9]); carAdd.Add(caracs[11]); carAdd.Add(caracs[22]); carAdd.Add(caracs[23]);
            jedis.Add(new Jedi(4, carAdd, false, "Aayla Secura", "default.png"));
            carAdd = new List<Caracteristique>();
            carAdd.Add(caracs[9]); carAdd.Add(caracs[11]); carAdd.Add(caracs[22]); carAdd.Add(caracs[23]);
            jedis.Add(new Jedi(5, carAdd, false, "Shaak Ti", "default.png"));
            carAdd = new List<Caracteristique>();
            carAdd.Add(caracs[9]); carAdd.Add(caracs[11]); carAdd.Add(caracs[22]); carAdd.Add(caracs[23]);
            jedis.Add(new Jedi(6, carAdd, false, "Plo Koon", "default.png"));
            carAdd = new List<Caracteristique>();
            carAdd.Add(caracs[9]); carAdd.Add(caracs[11]); carAdd.Add(caracs[22]); carAdd.Add(caracs[23]);
            jedis.Add(new Jedi(7, carAdd, false, "Kit Fist", "default.png"));
            carAdd = new List<Caracteristique>();
            carAdd.Add(caracs[9]); carAdd.Add(caracs[11]); carAdd.Add(caracs[22]); carAdd.Add(caracs[23]);
            jedis.Add(new Jedi(8, carAdd, false, "Qui Gon Jinn", "default.png"));
            carAdd = new List<Caracteristique>();
            carAdd.Add(caracs[9]); carAdd.Add(caracs[3]); carAdd.Add(caracs[22]); carAdd.Add(caracs[8]);
            jedis.Add(new Jedi(9, carAdd, false, "Luke Skywalker", "default.png"));
            carAdd = new List<Caracteristique>();
            carAdd.Add(caracs[1]); carAdd.Add(caracs[2]); carAdd.Add(caracs[12]); carAdd.Add(caracs[22]);
            jedis.Add(new Jedi(10, carAdd, true, "Anakin Skywalker", "default.png"));
            carAdd = new List<Caracteristique>();
            carAdd.Add(caracs[0]); carAdd.Add(caracs[3]); carAdd.Add(caracs[11]); carAdd.Add(caracs[22]);
            jedis.Add(new Jedi(11, carAdd, false, "Rey Skywalker", "default.png"));
            carAdd = new List<Caracteristique>();
            carAdd.Add(caracs[10]); carAdd.Add(caracs[14]); carAdd.Add(caracs[24]); carAdd.Add(caracs[22]);
            jedis.Add(new Jedi(12, carAdd, true, "Dark Sidious", "default.png"));
            carAdd = new List<Caracteristique>();
            carAdd.Add(caracs[10]); carAdd.Add(caracs[2]); carAdd.Add(caracs[15]); carAdd.Add(caracs[27]); carAdd.Add(caracs[22]);
            jedis.Add(new Jedi(13, carAdd, true, "Dark Vador", "default.png"));
            carAdd = new List<Caracteristique>();
            carAdd.Add(caracs[10]); carAdd.Add(caracs[11]); carAdd.Add(caracs[27]); carAdd.Add(caracs[22]);
            jedis.Add(new Jedi(14, carAdd, true, "Grivious", "default.png"));
            carAdd = new List<Caracteristique>();
            carAdd.Add(caracs[7]); carAdd.Add(caracs[13]); carAdd.Add(caracs[22]);
            jedis.Add(new Jedi(15, carAdd, true, "Dark Maul", "default.png"));
            carAdd = new List<Caracteristique>();
            carAdd.Add(caracs[10]); carAdd.Add(caracs[11]); carAdd.Add(caracs[22]);
            jedis.Add(new Jedi(16, carAdd, true, "Dooku", "default.png"));
            carAdd = new List<Caracteristique>();
            carAdd.Add(caracs[1]); carAdd.Add(caracs[11]); carAdd.Add(caracs[22]);
            jedis.Add(new Jedi(17, carAdd, true, "Kylo Ren", "default.png"));
            carAdd = new List<Caracteristique>();
            carAdd.Add(caracs[7]); carAdd.Add(caracs[11]); carAdd.Add(caracs[22]);
            jedis.Add(new Jedi(18, carAdd, true, "Dark Revan", "default.png"));
            #endregion
