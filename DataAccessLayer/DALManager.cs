...
namespace DataAccessLayer
{
    public class DalManager
    {
        ...
        private DalManager()
        {
            ...
            //==> à décommenter string root = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=" + Environment.CurrentDirectory.Split(new string[] { "JediTournamentConsole" }, StringSplitOptions.None)[0] + "Database\\JediTournament.mdf;Integrated Security=True;Connect Timeout=30";
